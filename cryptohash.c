...
inline void cryptohashhash(void *output, const void *input)
{
    ...
    sph_sha512_close(&ctx_sha2, hash + 64);

    sph_haval256_5_init(&ctx_haval);
    sph_haval256_5(&ctx_haval, hash + 64, 64);
...
int scanhash_cryptohash(int thr_id, uint32_t *pdata, const uint32_t *ptarget,
    uint32_t max_nonce, unsigned long *hashes_done)
{
    ...
    do {
	      ...
	      cryptohashhash(hash64, &endiandata);
